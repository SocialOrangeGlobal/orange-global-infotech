    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 w-full pointer-events-none">
        ...
        >
          ...
          >
            We deliver end-to-end solutions combining strategy, design, and engineering to help your business thrive in the digital landscape.
          </motion.p>
          ...
          >
            Optimized for:&nbsp;<RotatingText words={['Growth & Scaling', 'Modern Enterprises', 'Tech Startups', 'E-Commerce Brands', 'Global Expansion']} />
          </motion.div>
        </motion.div>
      </div>
    </section>
