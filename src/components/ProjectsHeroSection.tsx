    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 w-full pointer-events-none">
        ...
        >
          ...
          >
            Explore how we've helped innovative businesses transform their ideas into scalable, high-performance digital solutions.
          </motion.p>
          ...
          >
            Showcasing:&nbsp;<RotatingText words={['Web Applications', 'Enterprise Systems', 'Mobile Platforms', 'Cloud Infrastructures', 'UI/UX Innovations']} />
          </motion.div>
        </motion.div>
      </div>
    </section>
