    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 w-full pointer-events-none">
        ...
        >
          ...
          >
            Have a project in mind or need expert technical consultation? Reach out to our team of specialists today.
          </motion.p>
          ...
          >
            Available for:&nbsp;<RotatingText words={['Web Development', 'Enterprise Systems', 'Mobile Apps', 'Cloud Solutions', 'IT Consulting']} />
          </motion.div>
        </motion.div>
      </div>
    </section>
